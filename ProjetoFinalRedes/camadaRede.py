...
from listas import indicesParaEnvio
...
class CamadaRede:
    ...
    def enviaRREP(self, macDestino, sequencia, rota):
        ...
        # exibe pacote criado
        self.exibePacoteMacNum(
            msg,  self._camadaEnlace._camadaFisica._id, macDestino)
        ...
        if(self._camadaEnlace._pacotesLidos != []):
            ...
            if(cabecalho._requisicao == -1):
                ...
                if(cabecalho._macDestino == self._camadaEnlace._camadaFisica._id):
                    msg = "Pacote de dados: "
                    self.exibePacoteMacNum(
                        msg, self._camadaEnlace._camadaFisica._id, pacote._dados)
                else:
                    msg = "Chegada de pacote de dados mas não é pra mim "
                    self.exibePacote(
                        msg, self._camadaEnlace._camadaFisica._id, 0)
                    msg_2 = "Enviando pacote de dados para o nó seguinte"
                    self.exibePacote(
                        msg_2, self._camadaEnlace._camadaFisica._id, 0)
            ...
            # Se o pacote for recebido for um RREQ
                ...
                self.exibePacoteSeqNum(
                    msg, self._camadaEnlace._camadaFisica._id, cabecalho._sequenNum)
            ...
            # Se o pacote for recebido for um RREP
                ...
                self.exibePacoteSeqNum(
                    msg, self._camadaEnlace._camadaFisica._id, cabecalho._sequenList)
    ...
    def exibePacote(self, mensagem, id, macDestino):
        print("ID: ", id, "Mensg: ", mensagem, " macDest: ", macDestino)

    def exibePacoteMacNum(self, mensagem,  id, macDestino):
        print("ID: ", id, "Mensg: ", mensagem, " macDest: ", macDestino)

    def exibePacoteSeqNum(self, mensagem,  id, sequenNum):
        print("ID: ", id, "Mensg: ", mensagem,
              " Numero de sequencia: ", sequenNum)
